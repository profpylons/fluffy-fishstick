...
6. **ALWAYS present averages with standard deviation together** eg. "Average rating of 4.2 (± 0.3)"
...
- Step 3: Call execute_calculation with the rating numbers and operations: ['average', 'std_dev']
